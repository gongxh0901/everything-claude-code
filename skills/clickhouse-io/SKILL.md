---
name: clickhouse-io
description: ClickHouse 数据库模式、查询优化、分析和数据工程最佳实践，用于高性能分析工作负载。
---
...
ClickHouse 是一个面向列的数据库管理系统（DBMS），用于在线分析处理（OLAP）。它针对大数据集的快速分析查询进行了优化。
...
**切记**：ClickHouse 擅长分析工作负载。根据查询模式设计表，批量插入，利用物化视图实现实时聚合。
